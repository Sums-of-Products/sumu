...
double weight_sum_64(double w, bitmap *psets, int m, double *weights, int j, bitmap U, bitmap T, int t_ub) {
  double sum = 0;
...
double weight_sum_128(double w, bitmap *psets, int m, double *weights, int j, bitmap U1, bitmap U2, bitmap T1, bitmap T2, int t_ub) {
  bitmap_2 T;
  T.s1 = T1;
  T.s2 = T2;
  bitmap_2 U;
...
pair<double, vector<int>> weight_sum_contribs_128(double w, bitmap *psets, int m, double *weights, int j, bitmap U1, bitmap U2, bitmap T1, bitmap T2, int t_ub) {
  bitmap_2 T;
  T.s1 = T1;
  T.s2 = T2;
  bitmap_2 U;
